MissionDb = {
	objectives = {
		{
			...
			carriers = {
				...
				},
				{
					name = "Stennis",
					clients = {
							"Stennis F-14B Warm 1",
							"Stennis F-14B Warm 2",
							"Stennis F-14B Warm 3",
							"Stennis F-14B Warm 4",
							"Stennis FA-18C_hornet Warm 1",
				...
				},
				{
					...
					clients = {
							...
							"Peleliu OH58D Warm 1",
							"Peleliu OH58D Warm 2",
					},
					waypoints = {
						{ 
							x = 101300,
			...
			farps = {
				{
					...
					clients = {
							...
							"FARP Bewl Water OH58D Warm 1",
							"FARP Bewl Water OH58D Warm 2",
							"FARP Bewl Water OH58D Warm 3",
							"FARP Bewl Water OH58D Warm 4",
							"FARP Bewl Water CH-47Fbl1 Warm 1",
							"FARP Bewl Water CH-47Fbl1 Warm 2",
							"FARP Bewl Water CH-47Fbl1 Warm 3",
							"FARP Bewl Water CH-47Fbl1 Warm 4",
					}
				},
			},
			roadbases = {
			...
			farps = {
				{
					...
					clients = {
							...
							"FARP Timmy OH58D Warm 1",
							"FARP Timmy OH58D Warm 2",
							"FARP Timmy OH58D Warm 3",
							"FARP Timmy OH58D Warm 4",
							"FARP Timmy CH-47Fbl1 Warm 1",
							"FARP Timmy CH-47Fbl1 Warm 2",
							"FARP Timmy CH-47Fbl1 Warm 3",
							"FARP Timmy CH-47Fbl1 Warm 4",
					}
				},
			},
			roadbases = {
			...
			farps = {
				{
					...
					clients = {
							...
							"FARP Bluebird OH58D Warm 1",
							"FARP Bluebird OH58D Warm 2",
							"FARP Bluebird OH58D Warm 3",
							"FARP Bluebird OH58D Warm 4",
							"FARP Bluebird CH-47Fbl1 Warm 1",
							"FARP Bluebird CH-47Fbl1 Warm 2",
							"FARP Bluebird CH-47Fbl1 Warm 3",
							"FARP Bluebird CH-47Fbl1 Warm 4",
					}
				},
			},
			roadbases = {
			...
			farps = {
				{
					...
					clients = {
							...
							"FARP Guines OH58D Warm 1",
							"FARP Guines OH58D Warm 2",
							"FARP Guines OH58D Warm 3",
							"FARP Guines OH58D Warm 4",
							"FARP Guines CH-47Fbl1 Warm 1",
							"FARP Guines CH-47Fbl1 Warm 2",
							"FARP Guines CH-47Fbl1 Warm 3",
							"FARP Guines CH-47Fbl1 Warm 4",
					}
				},
			},
			roadbases = {
			...
			farps = {
				{
					...
					clients = {
							...
							"FARP Portland Bill OH58D Warm 1",
							"FARP Portland Bill OH58D Warm 2",
							"FARP Portland Bill OH58D Warm 3",
							"FARP Portland Bill OH58D Warm 4",
							"FARP Portland Bill CH-47Fbl1 Warm 1",
							"FARP Portland Bill CH-47Fbl1 Warm 2",
							"FARP Portland Bill CH-47Fbl1 Warm 3",
							"FARP Portland Bill CH-47Fbl1 Warm 4",
					}
				},
			},
			roadbases = {
			...
			farps = {
				{
					...
					clients = {
							...
							"FARP Morden Bog OH58D Warm 1",
							"FARP Morden Bog OH58D Warm 2",
							"FARP Morden Bog OH58D Warm 3",
							"FARP Morden Bog OH58D Warm 4",
							"FARP Morden Bog CH-47Fbl1 Warm 1",
							"FARP Morden Bog CH-47Fbl1 Warm 2",
							"FARP Morden Bog CH-47Fbl1 Warm 3",
							"FARP Morden Bog CH-47Fbl1 Warm 4",
					}
				},
			},
			roadbases = {
	...
	bluechief = {
	    airwings = {
			...
			{
				name = "5th CAW - Stennis",
				warehouse = "Stennis Unit #1",
				airbase = "Stennis Unit #1",
				squadrons = {
					{
						name = "5S-01",
						templateGroupName = "BLUE 5th CAW - Stennis 5S-01 CH-47D",
						initialInventory = 99,
						takeoffCold = false,
						parking = nil,
						capabilities = {
						...
						payloads = {
							{
								templateGroupName = "BLUE 5th CAW - Stennis 5S-01 CH-47D LOADOUT 0",
								missionTypes = { AUFTRAG.Type.OPSTRANSPORT }
							},
						}
					},
			...
			},
			{
				...
				squadrons = {
					{
						name = "6S-01",
						templateGroupName = "BLUE 6th CAW - GW 6S-01 CH-47D",
						initialInventory = 99,
						takeoffCold = false,
						parking = nil,
						capabilities = {
						...
						payloads = {
							{
								templateGroupName = "BLUE 6th CAW - GW 6S-01 CH-47D LOADOUT 0",
								missionTypes = { AUFTRAG.Type.OPSTRANSPORT }
							},
						}
					},
		...
		brigades = {
			{
				...
				platoons = {
					{
						name = "Stennis-01",
						templateGroupName = "BLUE 1st Stennis Stennis-01",
						initialInventory = 99,
						capabilities = {
							{ mission = AUFTRAG.Type.ONGUARD, performance = 50 },
						},
			...
			},
			{
				...
				platoons = {
					{
						name = "GW-01",
						templateGroupName = "BLUE 1st GW GW-01",
						initialInventory = 99,
						capabilities = {
							{ mission = AUFTRAG.Type.ONGUARD, performance = 50 },
						},
