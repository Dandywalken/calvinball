MissionDb = {
	objectives = {
		{
			...
			qrfs = {
				...
				},
				{
					...
					vehicleGroups = {
						{ name = "RED RG Gound 1-1" },
					},
					shipGroups = {
					},
					staticGroups = {
						{
							name = "Fecamp-Benouville Airwing Warehouse#00001",
							template = {
								name = "Fecamp-Benouville Airwing Warehouse",
								type = "Warehouse",
								x = 31318.406669687,
								y = 46583.935417675,
	...
	redchief = {
	    airwings = {
			...
			},
			{
				...
				squadrons = {
					{
						name = "Fecamp-Benouville 1",
						templateGroupName = "RED Fecamp-Benouville Fecamp-Benouville 1 Bf-109K-4",
						initialInventory = 0,
						takeoffCold = false,
						parking = nil,
						capabilities = {
						...
						payloads = {
							{
								templateGroupName = "RED Fecamp-Benouville Fecamp-Benouville 1 Bf-109K-4 LOADOUT 0",
								missionTypes = { AUFTRAG.Type.ESCORT }
							},
						}
					},
					{
						name = "Fecamp-Benouville 2",
						templateGroupName = "RED Fecamp-Benouville Fecamp-Benouville 2 Ju-88A4",
						initialInventory = 0,
						takeoffCold = false,
						parking = nil,
						capabilities = {
						...
						payloads = {
							{
								templateGroupName = "RED Fecamp-Benouville Fecamp-Benouville 2 Ju-88A4 LOADOUT 0",
	...
	bluechief = {
	    airwings = {
			...
			{
				name = "GOON OPS - Stoney Cross",
				warehouse = "Stoney Cross Airwing Warehouse#00001",
				airbase = "Stoney Cross",
				squadrons = {
					{
						name = "GOON OPS STONEY CROSS",
						templateGroupName = "BLUE GOON OPS - Stoney Cross GOON OPS STONEY CROSS B-17G",
						initialInventory = 99,
						takeoffCold = false,
						parking = nil,
						capabilities = {
						...
						payloads = {
							{
								templateGroupName = "BLUE GOON OPS - Stoney Cross GOON OPS STONEY CROSS B-17G LOADOUT 0",
								missionTypes = { AUFTRAG.Type.BOMBCARPET }
							},
						}
					},
